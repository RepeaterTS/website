...
import ProtodefTS from '../../data/ProtodefTS';
import RedstoneSource from '../../data/RedstoneSource';
import TripwireSource from '../../data/TripwireSource';
  ...
  data() {
    return {
      sources: {
        ...
        [ProtodefTS.id]: ProtodefTS,
        [RedstoneSource.id]: RedstoneSource,
        [TripwireSource.id]: TripwireSource,
      },
      source: MainSource,
